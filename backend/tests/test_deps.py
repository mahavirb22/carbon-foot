"""Tests for dependency-injection wiring (repository selection)."""
...
def test_in_memory_repository_when_firestore_disabled(monkeypatch):
...
def test_firestore_repository_when_enabled(monkeypatch):
    class _FakeClient:
