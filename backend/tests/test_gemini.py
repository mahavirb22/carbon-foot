...
Covers the full spectrum: disabled flag, network errors, malformed JSON,
validation failures, caching, client reuse, and the happy path.
"""
...
def _fake_genai_client(response_text: str):
    """Build a fake ``genai.Client`` that returns a canned model response."""
